...
<template>
    ...
    <div v-show="!showIntro" ref="mainContent" class="main-content">
        <div class="page-background">
            <!-- Welcome Section -->
            <div class="welcome">
                <h1 class="metallic-title fade-in title-shift">
                    THE NOBLE AWARD
                </h1>

                <!-- NEW SUBTITLE HERE -->
                <h2 class="welcome-subtitle fade-in">
                    Honoring the heroes among us
                </h2>

                <div class="top-button-container fade-in">
                    <nuxt-link to="/nominator/form" class="top-button"
                        >NOMINATE A HERO</nuxt-link
                    >
                    <nuxt-link to="/donate" class="top-button"
                        >DONATE</nuxt-link
                    >
                </div>
            ...
            <div class="container fade-in scroll-fade">
                ...
                <div class="info-container section-gap">
                    ...
                    <div
                        class="flex flex-col md:flex-row justify-center items-stretch gap-10 mt-8 mb-10"
                    >
                        <!-- Step Cards -->
                        <div class="step-card fade-in scroll-fade">
                            <h1>Step 1: Nominate a Hero</h1>
                            <p>
                                Know someone who deserves recognition? Submit a
                                nomination detailing their impact and
                                dedication.
                            </p>
                        </div>

                        <div
                            class="step-card fade-in scroll-fade"
                            style="transition-delay: 0.2s"
                        >
                            <h1>Step 2: Review & Selection</h1>
                            <p>
                                Each nomination is carefully reviewed to ensure
                                honorees receive the recognition they have
                                earned.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <p>
                                Award recipients are showcased on our website
                                and social media, receiving the Noble Award as a
                        ...
                        >
                            ...
                            <p>
                                Review the completed hero profile and share it
                                with others to celebrate their achievements!
                            </p>
                        </div>
                    </div>
                ...
                <div class="info-container section-gap nominate-section">
                    ...
                    <div
                        class="flex flex-wrap justify-center items-center gap-6 mt-20"
                    >
                        <!-- Hero Nominee Categories -->
                        <div class="hero-grid fade-in scroll-fade">
                            <div
                                class="hero-item fade-in scroll-fade"
                            ...
                            >
                                <div class="hero-frame">
                                    <img
                                        src="assets/military.png"
                                        alt="Active-Duty Military or Veterans"
                                        class="hero-img"
                                    />
                                </div>
